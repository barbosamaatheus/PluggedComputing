...
public class NumerosBinariosActivity extends TarefasManager {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_numeros_binarios);
        initViews();
        initVerify();
        ...
        mFinalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (respostasIsEmpty()) {
                    ...
                    validarCampos();
                    gerenciarResultados(2, getApplicationContext());
                }
            }
        });
    ...
    protected void initViews() {
        mMaiorValor = (EditText) findViewById(R.id.valorMaiorNB);
        mMenorValor = (EditText) findViewById(R.id.valorMenorNB);
        initButtons();
        initCartas();
        initNum();
        createCartas();
